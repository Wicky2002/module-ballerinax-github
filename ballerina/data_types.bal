...
public type WebhookPullRequest record {
    int id;
    string node_id?;
    string url?;
    string html_url?;
...
public type DeploymentReviewEvent record {
    ...
    record { string 'type?; # A User or WebhookTeam object depending on type
...
public type WebhookHeaders record {
    ...
    @http:Header {name: "X-GitHub-Hook-WebhookInstallation-Target-ID"}
    int xGitHubHookInstallationTargetID?;
    # The type of resource where the webhook was created
    @http:Header {name: "X-GitHub-Hook-WebhookInstallation-Target-Type"}
...
public type PullRequestReviewCommentEvent record {
    string action;
    WebhookPullRequestReviewComment comment;
...
public type WebhookIssueComment record {
    int id;
    string node_id?;
    string url?;
    string html_url?;
...
public type WebhookOrganization record {
    string login?;
    int id?;
    string node_id?;
    string url?;
...
public type WebhookTeam record {
    int id;
    string node_id?;
    string name;
    string slug;
...
public type WebhookInstallation record {
    int id?;
    string node_id?;
};
...
public type DeploymentStatusEvent record {
    string action;
    WebhookDeployment deployment;
    WebhookDeploymentStatus deployment_status;
    WebhookCheckRun check_run?;
    record {} workflow?;
    record {} workflow_run?;
    User sender;
...
public type WebhookRepository record {
    int id;
    string node_id?;
    # The repository name
    string name;
...
public type WebhookPullRequestReviewComment record {
    int id;
    string node_id?;
...
public type PullRequestReviewEvent record {
    string action;
    WebhookPullRequestReview review;
    WebhookPullRequest pull_request;
...
public type WebhookEnterprise record {
    int id?;
    string slug?;
    string name?;
    string node_id?;
...
public type WebhookDeploymentStatus record {
    int id;
    string node_id?;
    string state;
    User creator?;
...
public type SubIssuesEvent record {
    ...
    int parent_issue_id;
    # The parent issue.
    WebhookIssue parent_issue;
    # The repository of the parent issue.
    WebhookRepository parent_issue_repo;
    # The ID of the sub-issue.
    int sub_issue_id;
    # The sub-issue.
    WebhookIssue sub_issue;
    User sender?;
    WebhookRepository repository?;
    WebhookOrganization organization?;
    WebhookInstallation installation?;
...
public type WebhookIssue record {
    int id;
    string node_id?;
    string url?;
    string html_url?;
...
public type WebhookLabel record {
    int id;
    string node_id?;
    string url?;
    string name;
...
public type WebhookDeployment record {
    int id;
    string node_id?;
    string sha;
    string ref;
...
public type PersonalAccessTokenRequestEvent record {
    ...
    record { int id; User owner; # Permissions added by the request
        ...
        record { record {} organization?; record {} repository?; record {} other?;}  permissions_result?; string repository_selection?; string repositories_url?; WebhookRepository[] repositories?; boolean token_expired?; string token_expires_at?; string token_last_used_at?; string created_at?;}  personal_access_token_request;
    User sender?;
    WebhookOrganization organization?;
    WebhookInstallation installation?;
    WebhookEnterprise enterprise?;
...
public type WebhookMilestone record {
    int id?;
    string node_id?;
    int number?;
    string title?;
...
public type WebhookWorkflowRun record {
    int id;
    string name;
    string node_id?;
    int check_suite_id?;
...
public type WebhookCheckSuite record {
    int id;
    string node_id?;
    string head_branch?;
    string head_sha?;
...
public type PullRequestReviewThreadEvent record {
    ...
    record { string node_id?; WebhookPullRequestReviewComment[] comments?;}  thread;
    string updated_at?;
    User sender?;
    WebhookRepository repository?;
    WebhookOrganization organization?;
...
public type IssueDependenciesEvent record {
    ...
    WebhookIssue blocked_issue?;
    # The ID of the blocking issue.
    int blocking_issue_id?;
    WebhookIssue blocking_issue?;
    WebhookRepository blocking_issue_repo?;
    User sender?;
    WebhookRepository repository?;
    WebhookOrganization organization?;
    WebhookInstallation installation?;
...
public type WebhookPullRequestReview record {
    int id;
    string node_id?;
    User user?;
    string body?;
...
public type WebhookRelease record {
    int id;
    string node_id?;
    string url?;
    string html_url?;
...
public type MergeGroupEvent record {
    ...
    record { # The SHA of the merge group's head commit
        ...
        string base_ref; WebhookCommit head_commit?;}  merge_group;
...
public type WebhookCommit record {
    # The commit SHA
    string id;
    string tree_id?;
...
public type WebhookCheckRun record {
    int id;
    string name;
    string node_id?;
    string head_sha?;
...
public type GenericDataType DeploymentProtectionRuleEvent|WebhookPullRequest|PublicEvent|CommonEvent|CommitCommentEvent|DeploymentReviewEvent|ProjectColumnEvent|IssuesEvent|WebhookHeaders|RepositoryImportEvent|CheckRunEvent|RepositoryDispatchEvent|CustomPropertyEvent|PullRequestReviewCommentEvent|CheckSuiteEvent|TeamAddEvent|SponsorshipEvent|LabelEvent|WebhookIssueComment|GollumEvent|InstallationTargetEvent|MetaEvent|WebhookOrganization|MembershipEvent|StarEvent|CreateEvent|OrgBlockEvent|PingEvent|WebhookTeam|WatchEvent|InstallationRepositoriesEvent|WebhookInstallation|RepositoryAdvisoryEvent|DeploymentStatusEvent|'ProjectsV2ItemEvent|CustomPropertyValuesEvent|PackageEvent|GithubAppAuthorizationEvent|SecurityAndAnalysisEvent|PullRequestRef|WebhookRepository|WebhookPullRequestReviewComment|PullRequestReviewEvent|StatusEvent|WebhookEnterprise|DiscussionCommentEvent|MemberEvent|WebhookDeploymentStatus|RegistryPackageEvent|SubIssuesEvent|DeploymentEvent|ProjectEvent|WebhookIssue|SecretScanningAlertLocationEvent|RepositoryRulesetEvent|WebhookLabel|WebhookDeployment|WorkflowJobEvent|PullRequestEvent|DeleteEvent|OrganizationEvent|CommitAuthor|TeamEvent|CodeScanningAlertEvent|MarketplacePurchaseEvent|ProjectCardEvent|InstallationEvent|ForkEvent|PersonalAccessTokenRequestEvent|WebhookMilestone|MilestoneEvent|SecretScanningAlertEvent|WebhookWorkflowRun|'ProjectsV2Event|DependabotAlertEvent|SecurityAdvisoryEvent|WebhookCheckSuite|PushEvent|IssueCommentEvent|PullRequestReviewThreadEvent|Discussion|IssueDependenciesEvent|User|WebhookPullRequestReview|DiscussionEvent|ReleaseEvent|WorkflowDispatchEvent|RepositoryVulnerabilityAlertEvent|PageBuildEvent|WorkflowJob|BranchProtectionRuleEvent|WebhookRelease|BranchProtectionConfigurationEvent|DeployKeyEvent|'ProjectsV2StatusUpdateEvent|MergeGroupEvent|WebhookCommit|WebhookCheckRun|RepositoryEvent|WorkflowRunEvent|SecretScanningScanEvent;
